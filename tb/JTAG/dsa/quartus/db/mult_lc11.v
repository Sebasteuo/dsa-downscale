...
module  mult_lc11
	...
	assign
		wire_sft10a_in = {w261w, {w261w, {w261w, {w261w, {w261w, {(~ w_sum_node10w[38]), {w249w, {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {2{w261w}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w261w, {w_sum_node10w[37], {(~ w_sum_node10w[25]), {w249w, {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), (~ w_lone_sum_node11w[0])}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w261w, {w261w, {w261w, {w_sum_node10w[35], {w_sum_node10w[23], {w_sum_node10w[22:21]}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w261w, {w261w, {w261w, {w261w, {w249w, {w261w, w249w}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w249w, {wire_sft11a_out[15], {w249w, {w249w, {(~ w_lone_sum_node11w[8]), {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[36], {w_sum_node10w[24], {(~ w_sum_node10w[12]), {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w261w, {w261w, {w_lone_sum_node11w[10], {(~ w_lone_sum_node11w[9]), {w_sum_node10w[62], {w_sum_node10w[61], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14:13]}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w261w, {w261w, {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[27], {w_sum_node10w[26], {2{w261w}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w261w, {(~ w_sum_node10w[64]), {w_sum_node10w[63], {(~ w_sum_node10w[51]), {w249w, {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40:39]}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w261w, {w261w, {w261w, {w261w, {(~ w_lone_sum_node11w[7]), {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29:28]}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[10:0]},
		datab_node = {datab[10:0]},
		final_result_node = {w436w[21:0]},
		result = {final_result_node[21:0]},
		w249w = 1'b1,
		w261w = 1'b0,
		w436w = {wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[10:0]} & {11{w_le_datab_node8w[10]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[9]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[8]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[7]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[6]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[5]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[4]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[3]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[2]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[1]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[10:0]},
		w_lone_sum_node11w = {w_decoder_node9w[120:110]},

...
# ACDS 25.1 1129 linux 2025.12.04.23:06:09
# ----------------------------------------
...
# ----------------------------------------
# If dsa_jtag_sys is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "dsa_jtag_sys"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/hack/altera_lite/25.1std/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dsa_jtag_sys.v"
}
